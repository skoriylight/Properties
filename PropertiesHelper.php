...
//                "$join_table_name.entity_model_id = " .
...
//                        $lastQuery->innerJoin(
//                            ['osvm' . $counter => $tmp]
//                            , 'osvm' . $counter . '.entity_model_id = ' . 'osv' . ($counter - 1) . '.entity_model_id'
//                        );
//                        $lastQuery = $tmp;
//                    }
//
//                    $query->innerJoin(
//                        $subQuery->join[0][1]
//                        , 'osvm1.entity_model_id = ' . Yii::$app->db->quoteTableName($object->object_table_name) . '.id'
//                    );
//
//                    break;
//                default:
...
//                        , 'osvm.entity_model_id = ' . Yii::$app->db->quoteTableName($object->object_table_name) . '.id'
//                    );
//            }
//        }
//
...
//
//    /**
//     * @param \common\components\properties\models\Object $object
//     * @param array $psvs
//     * @param int $counter
//     * @param string $multiFilterMode
//     * @return Query
...
//        \common\components\properties\models\Object $object,
//        $psvs = [],
//        $counter = 1,
//        $multiFilterMode = ConfigConfigurationModel::MULTI_FILTER_MODE_INTERSECTION
//    )
...
//            case ConfigConfigurationModel::MULTI_FILTER_MODE_UNION:
//                if ($psvsCount > 1) {
//                    $having = "count($tableInner.entity_model_id) BETWEEN 1 AND $psvsCount";
//                    break;
//                }
//                // no break in case of $psvsCount is 1 or 0
//            default:
//                $having = "count($tableInner.entity_model_id) = $psvsCount";
//        }
//        $subQuery = (new Query)
//            ->select("$tableInner.entity_model_id")
//            ->distinct()
//            ->from(EntityStaticValue::tableName() . " $tableInner")
//            ->where([
//                "$tableInner.entity_id" => $object->id,
//                "$tableInner.property_static_value_id" => $psvs
//            ])
//            ->groupBy("$tableInner.entity_model_id")
//            ->having($having);
//
//        return $subQuery;
//    }
